...
<script>
   ...
   // }
	...
	//document.getElementsByClassName("btn").style.color=color;
    ...
    <style>
	  ...
	  th{font-size:15px;padding:3px;color:black;}
    ...
    <div class="container" style="">
      <div class="row">
        <div class="col-sm-12 col-md-12">
          <h2 class="outer">CHANDU KUMAR</h2>
          <div class="AutoScroll scroller" id="id" data-config='{"delay" : 1500 , "amount" : 8}'>
           <div class="wrapper" style="height:auto;"id="baby">
		 <!----<pre style="height:500px;position:relative;">---><p class="text-center cc" style="margin-top:10px;margin-bottom:10px;margin-left:45% auto;font-size:35px;">Resume</p>
<p><font style="float:left" class="cc">CHANDU KUMAR</font></P>
...
<p style="font-size:25px;">Objective :</p><p style="">To associate with an organization that gives an opportunity to share technical skills and</p><p>improve knowledge by being a part of the team that works dynamically towards the growth of</p><p>the organization.  </p>
...
<p class="c">	Good Experience in PSD to HTML Conversion </p>
<p class="c">	Understanding of designing a good User Experience</p>
<p class="c">	Front end Technologies Adobe Photo Shop,Notepad ++, HTML5, CSS3, Bootstrap.</p> 
<p class="c">	Good experience in responsive web designing and rich internet application.</p>
<p class="c">	Good Eye for UI/UX development.( Design Concepts,Theme Skills ,Template Creations</p>
<p class="c">	Conceptual understanding of User Interface Design and the Design Process.</p>
<p class="c">	Professional web themes, elegant themes, wireframes.</p>
<p class="c">	Excellent oral and written communication skills</p>
